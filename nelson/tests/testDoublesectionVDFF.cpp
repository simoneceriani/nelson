...
class Points2d3d : public Points2d3dBase < Points2d3d<matTypeUv, matTypeVv, matTypeWv>, matTypeUv, matTypeVv, matTypeWv, mat::Variable, mat::Dynamic, numPoints2d, numPoints3d > {
