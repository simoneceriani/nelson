...
struct Edge1_S : public nelson::EdgeBNarySectionBaseCRPT<Section, N1, N2, Section::EdgeBinaryAdapter, Edge1_S<N1,N2>> {
  ...
  Edge1_S(int n1 = N1, int n2 = N2) 
    : nelson::EdgeBNarySectionBaseCRPT<Section, N1, N2, Section::EdgeBinaryAdapter, Edge1_S<N1, N2>>(n1,n2)
  {
...
TEST_CASE("testEdgeNary", "[testEdgeNary]") {
  ...
  Edge1_S<1,1> e1_S(1,1);
  Section s;

  s.addEdge({0}, {1}, new Edge1_S<1,1>());
  //new Edge1_S<1, mat::Dynamic>(1,1);
  s.addEdge({0}, {1}, new Edge1_S<1, mat::Dynamic>(1,1));
  s.addEdge({0}, {1}, new Edge1_S<mat::Dynamic,1>(1,1));
  s.addEdge({0}, {1}, new Edge1_S<mat::Dynamic,mat::Dynamic>(1,1));
